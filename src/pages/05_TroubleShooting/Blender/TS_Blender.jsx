import blenderIssues from "./TS_Blender.js";
import { Link } from "react-router-dom";

export default function TSBlender() {
  // Sort issues by date, latest first
  const sortedIssues = blenderIssues.slice().sort((a, b) => (b.date > a.date ? 1 : -1));

  return (
    <div className="max-w-7xl mx-auto py-12">
      {/* Page title */}
      <h1 className="text-3xl font-bold mb-6">Blender Trouble Shooting</h1>
