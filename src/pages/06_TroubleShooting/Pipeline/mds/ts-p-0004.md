...
IMPORTANT: if you don't want to checkout files everytime, check the "Allwrite" option in Advanced. Check this doc for details: [How to Configure Settings In P4V To Get the Best Single-User Experience](https://davidcai1874.github.io/my-tech-art-station/troubleshooting/pipeline/ts-p-0004)
